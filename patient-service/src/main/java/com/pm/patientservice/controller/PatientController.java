...
public class PatientController {
    ...
    public ResponseEntity<PatientResponseDTO> createPatinet(@Validated({Default.class, CreatePatientValidationGroup.class}) @RequestBody PatientRequestDTO patientRequestDTO){
